...
function Pers:animacoes()
    ...
    self.spriteSheetR = love.graphics.newImage('arts/player/run.png')
    self.gridR = anim8.newGrid(32,32, self.spriteSheetR:getWidth(), self.spriteSheetR:getHeight())
    ...
    self.anims.aniR = anim8.newAnimation( self.grid('1-2', 1), 0.2 )
    self.anims.aniMf =self.anims.aniM:clone():flipH()

    self.anims.dash = love.graphics.newImage('arts/player/dash.png')
end
